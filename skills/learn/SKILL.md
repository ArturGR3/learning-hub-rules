...
3. When the user asks for a blueprint on a concept, also fetch `https://raw.githubusercontent.com/ArturGR3/learning-hub-rules/main/recipes/blueprint.md` and follow it.
